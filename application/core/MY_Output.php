...
class MY_Output extends CI_Output
{
     ...
     * @return void
     */
    public function set_layout($template_view)
    {
        $this->set_mode(self::OUTPUT_MODE_TEMPLATE);
        $template_view = str_replace(".php", "", $template_view);
        $this->_template = self::TEMPLATE_ROOT . $this->_theme_dir . $this->_layout_dir . $template_view;
    }
