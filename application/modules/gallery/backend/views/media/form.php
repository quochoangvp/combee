<form id="mediaForm" method="post"
    action="<?php echo site_url('api/gallery/media/'.$gallery['gallery_id']) ?>">
                ...
                <div class="form">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            ...
                            <button class="btn btn-default" type="button" onclick="go_to_gallery_details_page(<?php echo $gallery['gallery_id'] ?>)">Back</button>
                        </div>
                    </div>
                </div>
            </div>
